...
function Dashboard() {
  ...
  const [accounts, setAccounts] = useState([
    { id: '1', platform: 'facebook', username: 'TravelDiaries', avatar: '', isConnected: true, stats: { followers: '45.2K', posts: '182', engagement: '3.6%' } },
  ...
  const [recentPosts, setRecentPosts] = useState([
    { id: '1', title: 'Top 10 Hidden Gems in Switzerland 🇨🇭', description: 'Exploring the beauty of the Alps, hidden valleys, and crystal clear lakes.', date: '2026-07-08', platforms: ['facebook', 'youtube'], status: 'published', views: '28.4K', likes: '1.2K' },
    ...
    { id: '3', title: 'A Day in Venice: Vlog and Best Pizza Spots 🍕', description: 'Exploring the canals, hidden alleyways, and of course, testing local food!', date: '2026-07-04', platforms: ['youtube'], status: 'published', views: '12.8K', likes: '820' },
    { id: '4', title: 'Unboxing the Ultimate Travel Drone (4K)', description: 'First tests and review of the new drone. Cinematic footage included.', date: '2026-07-02', platforms: ['facebook', 'youtube', 'tiktok'], status: 'failed', views: '0', likes: '0' }
  ])
  ...
  useEffect(() => {
    ...
    fetch('/api/auth/accounts')
      ...
      .catch(err => console.log('Mocking accounts fetch in Dashboard...'))
    ...
    fetch('/api/analytics/overview')
      ...
      .catch(err => console.log('Mocking overview stats in Dashboard...'))
  }, [])
  ...
  const handleDisconnect = (id) => {
    if (confirm('Are you sure you want to disconnect this platform?')) {
      // Typically deletes the account from server, for mockup:
  ...
  return (
    <div>
      <div className="dashboard-header">
        <h1 className="gradient-text">Social Media Dashboard</h1>
      ...
      <div className="dashboard-layout-split">
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 600 }}>Recent Publications</h3>
                  ...
                  <tr key={post.id}>
                    <td>
                      <div className="post-preview-cell">
                        <div className="post-preview-thumb" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.75rem', color: 'rgba(255,255,255,0.2)' }}>
                          📝
                        </div>
                    ...
                    <td style={{ color: 'rgba(255,255,255,0.7)' }}>{post.likes} likes</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="glass-card">
          <h3 style={{ fontSize: '1.1rem', fontWeight: 600, marginBottom: '20px' }}>Activity Log</h3>
          <div className="activity-feed">
            <div className="activity-item">
              ...
              <div className="activity-content">
                <p style={{ fontSize: '0.9rem' }}>Video upload complete: <b>Top 10 Hidden Gems in Switzerland 🇨🇭</b></p>
            ...
            <div className="activity-item">
              ...
              <div className="activity-content">
                <p style={{ fontSize: '0.9rem' }}>Post published: <b>Top 10 Hidden Gems in Switzerland 🇨🇭</b></p>
                <span className="activity-time">2 hours ago</span>
              </div>
            </div>
            ...
            <div className="activity-item">
              ...
              <div className="activity-content">
                <p style={{ fontSize: '0.9rem' }}>Post creation failed on TikTok: <b>Unboxing the Ultimate Drone</b></p>
            ...
            <div className="activity-item" style={{ paddingBottom: '0' }}>
              ...
              <div className="activity-content">
                <p style={{ fontSize: '0.9rem' }}>Connected YouTube channel: <b>TravelDiaries YT</b></p>
